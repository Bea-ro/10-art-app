...
height: ${(props) => (props.itemType === 'artworks'  ? '65vh' : (props.itemType === 'authors'? '30vh' : 'auto'))};
overflow-y: ${(props) => (props.itemType === 'artworks'  ? 'scroll' : (props.itemType === 'authors'? 'scroll' : 'hidden'))};
gap: 40px;
